...
Provides: %{_sysconfdir}/cri-tools/1.34
...
touch %{buildroot}%{_sysconfdir}/cri-tools/1.34
...
%defattr(-,root,root,-)
%{_sysconfdir}/cri-tools/1.34
/usr/bin/crictl
/usr/bin/critest

%changelog
* Thu Oct 16 2025 Oracle Cloud Native Environment Authors <noreply@oracle.com> - 1.34.0-1
