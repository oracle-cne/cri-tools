...
Provides: %{_sysconfdir}/cri-tools/1.36
...
touch %{buildroot}%{_sysconfdir}/cri-tools/1.36
...
%defattr(-,root,root,-)
%{_sysconfdir}/cri-tools/1.36
/usr/bin/crictl
/usr/bin/critest

%changelog
* Sat Apr 25 2026 Oracle Cloud Native Environment Authors <noreply@oracle.com> - 1.36.0-1
